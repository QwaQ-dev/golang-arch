...
func CompressVideo(inputPath string, log *slog.Logger) error {
...
func CompressPhoto(inputPath string, log *slog.Logger) error {
	if !fileExists(inputPath) {
	...
	err := compressImageFile(inputPath, ext, log)
...
func compressImageFile(inputPath, ext string, log *slog.Logger) error {
